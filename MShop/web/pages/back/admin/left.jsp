    ...
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          ...
          <li><a href="<%=basePath%>pages/back/admin/goods/GoodsServletBack/listStatus?status=1" target="main">已上架商品</a></li>
          <li><a href="<%=basePath%>pages/back/admin/goods/GoodsServletBack/listStatus?status=0" target="main">已下架商品</a></li>
          <li><a href="<%=basePath%>pages/back/admin/goods/GoodsServletBack/listStatus?status=2" target="main">商品回收站</a></li>
        </ul>
      </div>
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="<%=basePath%>pages/back/admin/orders/OrdersServletBack/list" target="main">用户订单</a></li>
        </ul>
      </div>
    </div>
